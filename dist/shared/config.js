...
export function getCoordinatorPaths(projectPath) {
    ...
    return {
        ...
        inbox: (agentId) => path.join(coordinatorDir, 'agents', agentId, 'inbox'),
        outbox: (agentId) => path.join(coordinatorDir, 'agents', agentId, 'outbox'),
    };
}
// Ensure coordinator directories exist
export function ensureCoordinatorDirs(projectPath) {
