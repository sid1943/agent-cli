...
async function executeTaskWithClaude(task, workDir, model, agentType) {
...
function buildTaskPrompt(task, agentType) {
    let prompt = '';
    // Add agent context
...
function extractCreatedFiles(output) {
    const files = [];
    const patterns = [
